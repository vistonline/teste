...
if(strlen($_POST[DATA_INICIAL])>0)
{
	...
	if($_POST[controle_prest]!=='TODOS')
	{
		$controle_prest = "AND controle_prest = $_POST[controle_prest]";
	}
	else
	{
		$controle_prest = '';
	...
	$sql_vistoria = "SELECT * FROM ".$bancoDados.".vistoria_previa1 WHERE DTVISTORIA >= ".$data_inicial." AND DTVISTORIA <= ".$data_final." ".$controle_prest." AND DTTRANS >1";
	$result_vistoria = mysql_query($sql_vistoria,$db);

	$mensagem.="
<table width='100%' border='0' cellpadding='0' cellspacing='0'>
<tr>
<td height='27' class='fora4'>Seguradora</td>
<td height='27' class='fora4'>N&uacute;mero da vistoria</td>
<td height='27' class='fora4'>N&uacute;mero da placa</td>
<td height='27' class='fora4'>Numero do chassi</td>
<td height='27' class='fora4'>Nome do proponente</td>
<td height='27' class='fora4'>Cidade</td>
<td height='27' class='fora4'>Data da vistoria</td>
</tr>";
	...
	$mensagem.="<tr><td>".strtoupper($filtro)."</td><td>".$reg[NRVISTORIA]."</td><td>".strtoupper($reg[NRPLACA])."</td><td>".strtoupper($reg[NRCHASSI])."</td><td>".strtoupper($reg[NMPROPONENTE])."</td><td>".strtoupper($solicitacao[cidade])."</td><td>".$data_vistoria."</td></tr>";
	}
