...
<form name="form1" method="post" action="gerar_relatorio_xls2.php">
  <p>
    <label>
      Data Inicial :
  ...
  <p>Vistoriador : 
    ...
    <option value="TODOS">Todos</option>
        <? 
		$sql_prestador = 'SELECT * FROM ".$bancoDados.".user WHERE permissao = 1 AND roiterizador = '.$_SESSION[roteirizador].'';
