...
if( ($fileType=='Excel2007') && ($conteudoRecebido=='Tarifa Sompo;Código;Marca;Descrição;Capacidade;Ano inicial;Ano final;Fipe sem dígito') )
...
move_uploaded_file($_FILES['Filedata']['tmp_name'], $arquivo);
	...
	if($conteudoRecebido!='Tarifa Sompo;Código;Marca;Descrição;Capacidade;Ano inicial;Ano final;Fipe sem dígito')
