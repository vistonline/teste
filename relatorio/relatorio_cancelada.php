...
$objPHPExcel = $objReader->load("template/modelo_cancelada".$_SESSION['roteirizador'].".xlsx");    

$objPHPExcel->getProperties()->setCreator("Robson Souza Cassiano")
    						 ->setLastModifiedBy("Robson Souza Cassiano")
							 ->setTitle("Relatorio")
							 ->setSubject("Agendamentos Cancelados")
...
AND f.motivo IN ('80','00')";  

$result_sql1 = mysql_query($sql1,$db);

if(mysql_num_rows($result_sql1)==0){
  echo "<h1><center>Nenhum agendamento CANCELADO para este cliente no período solicitado!</center></h1>";
?>
...
$objWriter->save("relatoriosTemporarios/RELATORIO_CANCELADAS_".$empresa."_".$periodo1.".xlsx");

downloadFile( "relatoriosTemporarios/RELATORIO_CANCELADAS_".$empresa."_".$periodo1.".xlsx" );

unlink("relatoriosTemporarios/RELATORIO_CANCELADAS_".$empresa."_".$periodo1.".xlsx");
