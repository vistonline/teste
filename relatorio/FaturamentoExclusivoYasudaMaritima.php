...
<form name="form3" method="post" action="rel_faturamento_YasudaMaritima.php">
<table width="100%" border="00" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" colspan="2" style="color:#FFF; background:#000; text-align:center; font-weight:bold">&nbsp;&nbsp;Faturamento Exclusivo Yasuda Maritima (Unificado)</td>
  </tr>
  <tr onMouseOver="this.style.backgroundColor='#0099cc'" onMouseOut="javascript:this.style.backgroundColor=''" >
   ...
   <tr> 
    <td height="50" colspan="2">
      <br /><center><h3>Conforme determina&ccedil;&atilde;o da Yasuda Mar&iacute;tima, o relat&oacute;rio de faturamente ser&aacute; gerado com base na data de TRANSMISS&Atilde;O e n&atilde;o mais data da VISTORIA como vinha sendo gerado!</h3></center><br />
