...
{
$contem='0';
//conferindo os dados que o select conterá
...
{
	// SÓ MOSTRA AS QUE TEM CONTRATO DIRETO     //CONTRATO ATIVO
	if($seguradora['somenteSolicitacao']==0 && $seguradora['bloqueiaSeguradora']==0)
	{
		   ...
		   case "344": $option.= '<option value="344<>NACIONAL TRUCK">NACIONAL TRUCK</option>';break;
			...
			case "360": $option.= '<option value="360<>ALIANÇA TRUCK CAR">ALIAN&Ccedil;A TRUCK CAR</option>';break;
...
//se a prestadora não conter a determinada Seguradora então redirecionar para uma página que a prestadora contenha alguma seguradora
?>
...
<!-- FIM RELATÓRIO - BRADESCO SEGUROS -->
...
$sql_preco = "SELECT * FROM ".$bancoDados.".controle_vp_preco_seguradora WHERE filial_id = ".$prestador_filial[id]." AND seguradora = '0' AND roteirizador = ".$reg[roteirizador]."";
	...
	$DTTRANS = $reg["DTTRANS"]{6}.$reg["DTTRANS"]{7}.$reg["DTTRANS"]{4}.$reg["DTTRANS"]{5}.$reg["DTTRANS"]{0}.$reg["DTTRANS"]{1}.$reg["DTTRANS"]{2}.$reg["DTTRANS"]{3};
	$TPVISTORIA = $reg["TPVISTORIA"];
     if ($reg["CDFINALIDADE"]=='08'){ $CDFINALIDADE1 = "Substituição de Garan.";}
     if ($reg["CDFINALIDADE"]=='09'){ $CDFINALIDADE1 = "Avalaliação de Bem";}
...
<!-- FIM RELATÓRIO - BRADESCO CONSÓRCIO -->
...
switch($MES){
	...
	// ARRUMANDO PREÇO SE FOR POSTO DA SYLLUS VISTORIAS
	...
	// ARRUMANDO PREÇO SE FOR POSTO DA REALIZA VISTORIAS
	if($reg['roteirizador']=='90'){
		$PRECO="032,70";
		}
...
//pegando se é data de transmissão ou vistoria
...
?>
<!-- FIM RELATÓRIO FRUSTRADA MAPFRE -->
...
<!-- RELATÓRIO FRUSTRADA MAPFRE WARRANTY-->
...
<!-- FIM RELATÓRIO - ALLIANZ -->

<!-- RELATÓRIO - SUL AMERICA -->
...
<!-- FIM RELATÓRIO - VERTICE-->

<!-- RELATÓRIO - ACE SEGURADORA -->
...
<!--FIM RELATÓRIO - CAIXA SEGURADORA -->
...
$sql_preco = "SELECT * FROM ".$bancoDados.".controle_vp_preco_seguradora WHERE filial_id = ".$prestador_filial[id]." AND seguradora = '55' AND roteirizador = ".$reg[roteirizador]."";
	...
	$CDCORRETORSUSEP = str_pad($reg["CDCORRETORSUSEP"], 14 );
	$NRPLACA = str_pad($reg["NRPLACA"], 7, "0", STR_PAD_LEFT);
	$NMCORRETOR = strtr($cor['corretor'], "ŠŒŽšœžŸ¥µÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýÿ", "SOZsozYYuAAAAAAACEEEEIIIIDNOOOOOOUUUUYsaaaaaaaceeeeiiiionoooooouuuuyy");
	//PREPARA O CONTEÚDO A SER GRAVADO  
...
<!-- MONTANDO O ARQUIVO (XLS) DOS RELATÓRIO -->
...
if( ( ($_GET[visualiza] == "ok") && ($_POST[tipo_relatorio] == 'DTVISTORIA') ) || (($_GET[visualiza] == "ok") && ($_POST[tipo_relatorio] == 'DTTRANS') ) || ( ($_GET[visualiza] == "ok") && ($_POST[tipo_relatorio] == 'DTVISTORIA_CONSORCIOBRADESCO') )  || ( ($_GET[visualiza] == "ok") && ($_POST[tipo_relatorio] == 'DTTRANS_CONSORCIOBRADESCO') ) || ( ($_GET[visualiza] == "ok") && ($_POST[tipo_relatorio] == 'DTVISTORIA_SEGUROS') ) || ( ($_GET[visualiza] == "ok") && ($_POST[tipo_relatorio] == 'DTTRANS_SEGUROS') ))
{
	...
	$cabecalho = "Data de Transmissão ".$_POST[DATA_INICIAL]." a ".$_POST[DATA_FINAL];
	}
	else
	{
  ...
  switch ($cliente[0]){
	  ...
	  case 344 : $seguradora_cliente = "NACIONAL TRUCK"; break;
		...
		case 360 : $seguradora_cliente = "ALIANÇA TRUCK CAR"; break;
  ...
  if($cliente[0]==60||$cliente[0]==44||$cliente[0]==38)
{
  ...
  else if($cliente[0]==67)
  {
	...
	case 200 : $prestadora = "QUINTÃO VISTORIAS"; break;
...
echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  ...
  <tr> 
    <td height='23' colspan='20' bgcolor='#D2D2D2' align='middle' valign='center'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Relatório ".$cabecalho." </font></td>
  </tr>
  <tr>
    ...
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Nº VISTORIA</font></td>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Nº SOLICITAÇÃO</font></td>
	...
	<td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>VEÍCULO</font></td>
	...
	<td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>DATA DIGITAÇÃO</font></td>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>DATA TRANSMISSÃO</font></td>
...
elseif($cliente[0]=='83'){ // MITSUI 
  ...
  <tr>
    <td height='23' colspan='23' bgcolor='#D2D2D2' align='middle' valign='center'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Relatório ".$cabecalho." </font></td>
  </tr>
  <tr>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>ITEM</font></td>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Nº VISTORIA</font></td>
  ...
  ";
	...
	elseif($_SESSION['roteirizador']==200){ // QUINTÃO VISTORIAS
	 // outras seguradoras
	echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
  ...
  <tr>
    <td height='23' colspan='21' bgcolor='#D2D2D2' align='middle' valign='center'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Relatório ".$cabecalho." </font></td>
  </tr>
  <tr>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>ITEM</font></td>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Nº VISTORIA</font></td>
  ...
  ";
	...
	elseif($cliente[0]=='202'){// NORDESTE (INPEÇÕES RISCO) 
	echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
  ...
  <tr>
    <td height='23' colspan='19' bgcolor='#D2D2D2' align='middle' valign='center'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Relatório ".$cabecalho." </font></td>
  </tr>
  <tr>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>ITEM</font></td>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Nº VISTORIA</font></td>
  ...
  <tr>
    <td height='23' colspan='22' bgcolor='#D2D2D2' align='middle' valign='center'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Relatório ".$cabecalho." </font></td>
  </tr>
  <tr>                    
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>ITEM</font></td>
    <td align='center' bgcolor='#FFFF00'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Nº VISTORIA</font></td>
...
if($cliente[0]=='67'){
	...
	if ($vistoria["SEGURADORA"]=='61'){ // BUSCA MOTIVO DA SOLICITAÇÃO
...
elseif($cliente[0]=='202'){ // nordeste (inpeções de risco)
  ...
  <tr>
	...
	} // FIM nordeste (inpeções de risco)
else{ // outras seguradoras
	...
	if($cliente[0]=='83'){ 
	  ...
	  ";
		...
		if($vistoria['CDCIA']!=''){
			...
			$tipoVistoriador='CONSULTOR - ASSOCIAÇÃO';  
			}else{
				$tipoVistoriador='VISTORIADOR - QUINTÃO';
				}
		echo "
		</font></td>
...
echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
    <td height='23' colspan='16' bgcolor='#D2D2D2'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Relatório ".$cabecalho." </font></td>
  </tr>
  <tr>
    <td height='23' bgcolor='#EFEFEF'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Número da Vistoria</font></td>
    ...
    <td bgcolor='#EFEFEF'><font style='font-size: 12px; color:#000000; font-weight: bold; font-family: Arial, Helvetica, sans-serif;'>Descrição/Veículo</font></td>
  ...
  ";
	...
	$finalidade = "";
        ...
        if ($vistoria["CDFINALIDADE"] =='5')  {$finalidade = "INCLUSAO ACESSÓRIO";}
