...
<form name="form3" method="post" action="rel_faturamento_totalizado.php">
<table width="100%" border="00" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" colspan="2" style="color:#FFF; background:#000; text-align:center; font-weight:bold">&nbsp;&nbsp;Faturamento Totalizado</td>
  </tr>
