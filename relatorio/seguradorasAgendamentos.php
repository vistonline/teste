...
<form name="form3" method="post" action="./relatorio/rel_seguradorasAgendamentos.php">
<table width="100%" border="00" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" colspan="2" style="color:#FFF; background:#000; text-align:center; font-weight:bold">&nbsp;&nbsp;Relat&oacute;rio de Agendamentos</td>
  </tr>
  <tr onMouseOver="this.style.backgroundColor='#0099cc'" onMouseOut="javascript:this.style.backgroundColor=''" >
  		
        <td width="25%" height="50" class="style18">&nbsp;&nbsp;Status do Agendamento: </td>
      ...
      <div id="" class="style12">
        <select name="tipo" id="tipo">
          ...
          <option value="frustradas">FRUSTRADAS</option>
        </select>
      </div>      </td>
    </tr>
