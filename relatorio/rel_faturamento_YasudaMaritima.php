...
$objPHPExcel = $objReader->load("template/modelo_YasudaMaritima.xlsx");
...
$sql1 = "SELECT * FROM ".$bancoDados.".vistoria_previa1 WHERE 
	SEGURADORA IN (61,72) AND DTTRANS >=".$data_inicio." AND DTTRANS <=".$data_fim." AND roteirizador = ".$_SESSION[roteirizador]." order by DTVISTORIA ASC";
...
@mkdir('faturamento_YasudaMaritima/', 0777);
@chmod('faturamento_YasudaMaritima/', 0777);  
@mkdir('faturamento_YasudaMaritima/'.$_SESSION['roteirizador'], 0777);
@chmod('faturamento_YasudaMaritima/'.$_SESSION['roteirizador'], 0777);
$objWriter->save("faturamento_YasudaMaritima/".$_SESSION['roteirizador']."/FATURAMENTO_".$empresa."_".$periodo1.".xlsx");

downloadFile( "faturamento_YasudaMaritima/".$_SESSION['roteirizador']."/FATURAMENTO_".$empresa."_".$periodo1.".xlsx" );
