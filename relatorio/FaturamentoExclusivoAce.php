...
<form name="form3" method="post" action="rel_faturamento_ace.php">
<table width="100%" border="00" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" colspan="2" style="color:#FFF; background:#000; text-align:center; font-weight:bold">&nbsp;&nbsp;Faturamento Exclusivo ACE Seguros</td>
  </tr>
