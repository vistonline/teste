...
<title>Faturamento Exclusivo MARITIMA SEGUROS</title>
...
<form name="form1" method="post" action="rel_faturamento_maritima.php">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F3F3F3">
  <tr  width="100%">
    <td height="25" colspan="2" background="../../barra2.jpg" style="color:#FFF; font-weight:bold"><div align="center">Faturamento Exclusivo MARITIMA SEGUROS</div></td>
  </tr>
