...
<form name="form1" method="post" action="relatorio/relatorio_frustrada.php">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr  width="100%">
    <td height="50" colspan="2" style="color:#FFF; background:#000; font-weight:bold"><div align="center"><div align="center">Relat&oacute;rio de Solicita&ccedil;&otilde;es Frustradas</div></td>
  </tr>
