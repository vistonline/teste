...
<title>Relatório de Agendamentos CANCELADOS</title>
...
<form name="form1" method="post" action="relatorio/relatorio_cancelada.php">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr  width="100%">
    <td height="50" colspan="2" style="color:#FFF; background:#000; font-weight:bold"><div align="center"><div align="center">Relat&oacute;rio de Agendamentos CANCELADOS</div></td>
  </tr>
...
$sql_filial = "SELECT codigo_filial,nome_filial FROM ".$bancoDados.".controle_vp_filial WHERE roteirizador=".$_SESSION['roteirizador']." ORDER BY nome_filial";
$result_filial = @mysql_query($sql_filial,$db);
while ($filial = @mysql_fetch_assoc($result_filial))   
{
echo '<option value="'.$filial['codigo_filial'].'">'.strtoupper($filial['nome_filial']).'</option>'	;
	}		
