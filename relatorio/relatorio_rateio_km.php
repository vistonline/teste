...
//$sql_extra = "SELECT * FROM ".$bancoDados.".vistoria_extra WHERE solicitacao = ".$vistoria1[NUMEROSOLICITACAO]." ";
    ...
    if($vistoria1['SEGURADORA']=='86')
      {
	    $sql_extra = "SELECT * FROM ".$bancoDados.".vistoria_previa1 WHERE NUMEROSOLICITACAO = ".$vistoria1[NUMEROSOLICITACAO]."";
      }
			...
			if($vistoria1['SEGURADORA']=='0'||$vistoria1['SEGURADORA']=='87'||$vistoria1['SEGURADORA']=='88'||$vistoria1['SEGURADORA']=='89'||$vistoria1['SEGURADORA']=='86'){
			$km1 = $km1+intval($vistoria1['km_percorrido']);
			}
			else{
  ...
  $sql_vistoria2 = "SELECT DISTINCT CDSUCURSAL FROM ".$bancoDados.".vistoria_previa1 WHERE 
	...
	{ 
		while ($vistoria3 = mysql_fetch_array($result_vistoria3))
		{
			...
			if($vistoria3['SEGURADORA']=='86'){
			$sql_extra3 = "SELECT * FROM ".$bancoDados.".vistoria_previa1 WHERE NUMEROSOLICITACAO = ".$vistoria3['NUMEROSOLICITACAO']."";
			}
			...
			if($vistoria3['SEGURADORA']=='0'||$vistoria3['SEGURADORA']=='87'||$vistoria3['SEGURADORA']=='88'||$vistoria3['SEGURADORA']=='89'||$vistoria3['SEGURADORA']=='86'){
			$km3 = $km3+intval($vistoria3['km_percorrido']);
			}		
			else{
...
/*
 ...
 switch($_GET['seg'])
   {
    case '60': $seguradora_nome = "MAPFRE SEGURADORA"; break;
    case '86': $seguradora_nome = "ASCARPE"; break;
    case '44': $seguradora_nome = "CAIXA SEGURO"; break;
    case '88': $seguradora_nome = "COMCARGA"; break;
    case '95': $seguradora_nome = "ASSOFINSP"; break;
    case '89': $seguradora_nome = "APROCAM"; break;
    case '96': $seguradora_nome = "APPA"; break;
    case '30': $seguradora_nome = "ASSETRAC"; break;
    case '31': $seguradora_nome = "BUREAU DE BENEFÍCIOS"; break;
    case '76': $seguradora_nome = "CREDIPE"; break;
    case '55': $seguradora_nome = "HDI"; break;
   }
	if( !(($_GET[seg]=='76') || ($_GET[seg]=='89') || ($_GET[seg]=='86') || ($_GET[seg]=='88') || ($_GET[seg]=='95') || ($_GET[seg]=='96') || ($_GET[seg]=='30') || ($_GET[seg]=='31') ) )
  ...
  <tr valign='bottom'>
    <td width='85' align='middle' valign='center' nowrap><strong>ITEM</strong></td>
    <td width='125' align='middle' valign='center' nowrap><strong>SOLICITAÇÃO&nbsp;</strong></td>
    <td width='125' align='middle' valign='center' nowrap><strong>LAUDO&nbsp;</strong></td>
    <td width='85' align='middle' valign='center' nowrap><strong>PLACA&nbsp;</strong></td>
    ...
    <td width='190' align='middle' valign='center' nowrap><strong>VEÍCULO&nbsp;</strong></td>
    <td width='81' align='middle' valign='center' nowrap><strong>DATA VISTORIA&nbsp;</strong></td>
    <td width='140' align='middle' valign='center' nowrap><strong>DATA TRANSMISSÃO&nbsp;</strong></td>
    <td width='68' align='middle' valign='center' nowrap><strong>PRAZO&nbsp;</strong></td>
    <td width='92' align='middle' valign='center' nowrap><strong>CD CORRETOR&nbsp;</strong></td>
    <td width='96' align='middle' valign='center' nowrap><strong>CORRETOR&nbsp;</strong></td>
    <td width='80' align='middle' valign='center' nowrap><strong>SUCURSAL&nbsp;</strong></td>
    ...
    <td width='200' align='middle' valign='center' nowrap><strong>MOTIVO&nbsp;</strong></td>
  </tr>
  ";
  //PARA ascarpe APENAS
...
<!--    <td width='116' align='middle' valign='center' nowrap><strong>SUCURSAL&nbsp;</strong></td>-->
  ...
  $contador=1;
	...
	{ 
		while ($vistoria3 = mysql_fetch_array($result_vistoria3))
		{
			...
			$sql_extra3 = "SELECT * FROM ".$bancoDados.".vistoria_extra WHERE solicitacao = ".$vistoria3[NUMEROSOLICITACAO]." AND avaliacao != '04' ";
			//$sql_previa = "SELECT * FROM ".$bancoDados.".vistoria_previa1 WHERE NUMEROSOLICITACAO = ". $vistoria3['NUMEROSOLICITACAO'] ;
  ...
  <tr valign='bottom'  height='20'>
    <td width='85' align='middle' valign='center' nowrap>".$contador."</td>
    <td width='125' align='middle' valign='center' nowrap>".$extra3[proposta]."</td>
    <td width='125' align='middle' valign='center' nowrap>".$vistoria3[NRVISTORIA]."</td>
    <td width='85' align='middle' valign='center' nowrap>".$vistoria3[NRPLACA]."</td>
    <td width='190' align='middle' valign='center' nowrap>".$vistoria3[NMPROPONENTE]."</td>
    <td width='190' align='middle' valign='center' nowrap>".$vistoria3[NRCHASSI]."</td>
    <td width='190' align='middle' valign='center' nowrap>".$vistoria3['NMVEICULO']."</td>
    <td width='81' align='middle' valign='center' nowrap>".$data_vistoria."</td>
    <td width='140' align='middle' valign='center' nowrap>".$data_transmissao."</td>
    <td align='middle' valign='center' nowrap width='68'>".$quantidade_falta."</td>
    <td width='92' align='middle' valign='center' nowrap>".$codigo_corretor."</td>
    <td width='96' align='middle' valign='center' nowrap>".$vistoria3[NMCORRETOR]."</td>
    <td width='80' align='middle' valign='center' nowrap>".$vistoria3[CDSUCURSAL]."</td>
    <td width='192' align='middle' valign='center' nowrap>".$user[nome]."</td>
    <td width='185' align='middle' valign='center' nowrap>".$solicitacao[cidade]."</td>
    <td width='58' align='middle' valign='center' nowrap>".$extra3[KM_rodado]."</td>
    <td width='200' align='middle' valign='center' nowrap>".$solicitacao[motivo]."</td>
  </tr>";
  $contador++;
  			}
  else
    {
			...
			//$extra3 = mysql_fetch_array($result_previa3);
...
*/
  echo "
  <tr valign='bottom'  height='20'>
    <th align='middle' valign='center' nowrap width='22'>&nbsp;</th>
    <td width='85'align='middle' valign='center' nowrap>".$contador."</td>
    <td width='198' align='middle' valign='center' nowrap>".$solicitacao['id']."</td>
    <td width='125' align='middle' valign='center' nowrap>".$vistoria3[NRVISTORIA]."</td>
    <td width='178' align='middle' valign='center' nowrap>".$vistoria3[NRPLACA]."</td>
    <td width='190' align='middle' valign='center' nowrap>".$vistoria3[NMPROPONENTE]."</td>
    <td width='190' align='middle' valign='center' nowrap>".$vistoria3[NRCHASSI]."</td>
    <td width='81' align='middle' valign='center' nowrap>".$data_vistoria."</td>
<!--    <td width='118'>".$data_transmissao."</td>
    <td align='middle' valign='center' nowrap width='68'>".$quantidade_falta."</td> -->
    <td width='92' align='middle' valign='center' nowrap>".$vistoria3['CDCORRETOR']."</td>
    <td width='96' align='middle' valign='center' nowrap>".$vistoria3[NMCORRETOR]."</td>
<!--    <td width='116'>".$vistoria3[CDSUCURSAL]."</td>-->
    <td width='192' align='middle' valign='center' nowrap>".$user[nome]."</td>
    <td width='185' align='middle' valign='center' nowrap>".$solicitacao[cidade]."</td>
    <td width='58' align='middle' valign='center' nowrap>".$vistoria3[km_percorrido]."</td>
    <td width='85' align='middle' valign='center' nowrap>".$solicitacao[motivo]."</td>
  </tr>";
  $contador++;
