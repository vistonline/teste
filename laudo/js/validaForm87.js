...
// valida empresa produtora em layouts que possuem este campo 
if(document.getElementById("empresaProdutora")!=null && document.form1.empresaProdutora.value=="" ){
	window.alert("Escolha uma Empresa Produtora");
	return false;
	}
