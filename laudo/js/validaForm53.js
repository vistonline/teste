...
if(document.form1.CDFILIAL.value==''){
document.form1.CDFILIAL.focus();
window.alert('Selecione a FILIAL da GENERALI');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
if(document.form1.HRVISTORIA1.value.length<5){
document.form1.HRVISTORIA1.focus();                 
...
if(document.form1.HRVISTORIA1.value.charAt(0)+""+document.form1.HRVISTORIA1.value.charAt(1)>23){
document.form1.HRVISTORIA1.focus();
window.alert('Hora Final da vistoria Inválida');   
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
if(document.form1.HRVISTORIA1.value.charAt(3)+""+document.form1.HRVISTORIA1.value.charAt(4)>59){
document.form1.HRVISTORIA1.focus();
window.alert('Hora Final da vistoria Inválida');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
