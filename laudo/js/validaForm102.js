...
window.alert('Selecione o campo:\nInspetor que realizou o serviço');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
document.form1.DTVISTORIA.focus();
window.alert('Preencha o campo:\n Data corretamente. Não é aceito ano inferior a 2016.');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
return false;
}
...
if(document.form1.CDFINALIDADE.value==''||document.form1.CDFINALIDADE.value=='INFORME'){
...
if(document.form1.CDFINALIDADE.value=='02' || document.form1.CDFINALIDADE.value=='04' ){
	if(document.form1.CMPECAOUTRAS.value==''){
		document.form1.CMPECAOUTRAS.focus();
	...
	if(document.form1.CDOPCIONAIS.value==''){
		document.form1.CDOPCIONAIS.focus();
		window.alert('Preencha o campo:\nProblema constatado pelo técnico');
		document.getElementById('buttonGravar1').removeAttribute('hidden');
		document.getElementById('buttonGravar2').removeAttribute('hidden');
	...
	if(document.form1.DSOUTRASPECAS.value==''){
		document.form1.DSOUTRASPECAS.focus();
		window.alert('Preencha o campo:\nAção corretiva do técnico');
		document.getElementById('buttonGravar1').removeAttribute('hidden');
		document.getElementById('buttonGravar2').removeAttribute('hidden');
...
for(var i = 1; i<=33; i++){  
	if( (document.getElementsByName(i+"_INI")[0].checked=='' && document.getElementsByName(i+"_INI")[1].checked=='') && document.getElementsByName(i+"_NP")[0].checked==''){
		document.getElementsByName(i+"_INI")[0].focus();    
		window.alert('Preencha o Item do Check List (INÍCIO): '+document.getElementsByName(i+"_INI")[0].title+'\n ou se o veículo não possui o item assinalar (NAO POSSUI)');
		document.getElementById('buttonGravar1').removeAttribute('hidden');
		document.getElementById('buttonGravar2').removeAttribute('hidden');
	...
	if( (document.getElementsByName(i+"_FIM")[0].checked=='' && document.getElementsByName(i+"_FIM")[1].checked=='') && document.getElementsByName(i+"_NP")[0].checked==''){
		document.getElementsByName(i+"_FIM")[0].focus();    
		window.alert('Preencha o Item do Check List (FIM): '+document.getElementsByName(i+"_FIM")[0].title+'\n ou se o veículo não possui o item assinalar (NAO POSSUI)');
		document.getElementById('buttonGravar1').removeAttribute('hidden');
		document.getElementById('buttonGravar2').removeAttribute('hidden');
