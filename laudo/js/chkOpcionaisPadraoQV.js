...
function chk_opcional()
{
  ...
  var quantidade = document.getElementById('checar_opcao3').innerHTML.split('checar_opcional_').length;
...
{
  var quantidade = document.getElementById('checar_opcao3').innerHTML.split('checar_acessorios_').length;
...
{
  var quantidade = document.getElementById('checar_opcao3').innerHTML.split('checar_equipamento_').length;
...
function chk_avaria()
{
  var quantidade = document.getElementById('checar_opcao3').innerHTML.split('checar_avaria_').length;
