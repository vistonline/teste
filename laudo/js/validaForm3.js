...
function valida()
{
	...
	if(document.getElementById('endereco_posto')!=null && document.getElementById('endereco_posto').selectedIndex<1)
	{
	...
	window.alert('Preencha o campo:\nQuilometragem para a realização da VP');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
...
return false;
	...
	document.form1.HRVISTORIA1.focus();
	window.alert('Hora final da vistoria inválida');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
	...
	document.form1.HRVISTORIA1.focus();
	window.alert('Hora final da vistoria não pode ser igual ou menor que Hora Inicial');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
...
if(document.getElementById('placaRecebida')!=null){
	...
	document.form1.NRCHASSI.focus();
	window.alert('Número do Chassi digitado no primeiro campo não confere com o "'+chassi_i+'"\nNúmero do Chassi digitado no segundo campo"'+chassi_p+'"!');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
...
if(confere_chassi1!==8&&confere_chassi1!==9&&confere_chassi1!==12&&confere_chassi1!==17&&document.form1.NRANOFABRICACAO.value<=1988){
document.form1.NRCHASSI.focus();
window.alert('Preencha o campo:\nNúmero do Chassi');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
return false;
	...
	window.alert('Preencha o campo:\nLacre obrigatório no emplacamento');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
	...
	window.alert('Selecione o campo:\nNo minimo três vidros com a gravação do número do chassi exceto veiculos com vidros não originais de fabrica');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
	...
	window.alert('Selecione o campo:\nVeículos Importado que não apresente a numeração de chassi gravada em baixo relevo no monobloco/chassi');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
	...
	window.alert('Selecione o campo:\nExiste gravação no Pára-Brisas e em mais dois vidros do veículo ');
	document.getElementById('buttonGravar1').removeAttribute('hidden');
	document.getElementById('buttonGravar2').removeAttribute('hidden');
