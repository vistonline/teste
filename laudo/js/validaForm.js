...
if(document.form1.solicita_contem.value=='S'){
...
document.form1.HRVISTORIA.focus();
window.alert('Hora da realização da vistoria INVÁLIDA');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
return false;
}

if(document.form1.HRVISTORIA.value.charAt(0)+""+document.form1.HRVISTORIA.value.charAt(1)>24){       
document.form1.HRVISTORIA.focus();
window.alert('Hora da realização da vistoria INVÁLIDA');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
var prefixoProposta=document.form1.proposta1.value.charAt(0)+''+document.form1.proposta1.value.charAt(1)+''+document.form1.proposta1.value.charAt(2)+''+document.form1.proposta1.value.charAt(3)+''+document.form1.proposta1.value.charAt(4)+''+document.form1.proposta1.value.charAt(5)+''+document.form1.proposta1.value.charAt(6)+''+document.form1.proposta1.value.charAt(7);  

if( (prefixoProposta=='BRADESCO' && document.form1.SEGURADORA.value=='0') && (document.form1.CDFINALIDADE.value!='08' && document.form1.CDFINALIDADE.value!='09') ){
document.form1.CDFINALIDADE.focus();
window.alert('Esta é uma solicitação BRADESCO CONSÓRCIO\na finalidade deve ser: Consórcio - Avaliação de Bem\nou Consórcio - Substituição de Garantia\nFavor verificar na solicitação e manter\na finalidade CORRETA!');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
document.form1.NRANOFABRICACAO.focus();
window.alert('Preencha o campo:\nAno de Fabricação do veículo com 4 dígitos');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
document.form1.NRANOMODELO.focus();
window.alert('Preencha o campo:\nAno do Modelo do veículo com 4 dígitos');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
document.form1.NRANOMODELO.focus();
window.alert('Ano do Modelo do veículo não pode ser menor que o Ano de Fabricação');
document.getElementById('buttonGravar1').removeAttribute('hidden');
document.getElementById('buttonGravar2').removeAttribute('hidden');
...
if(document.form1.CDRESSALVA.value==''){
